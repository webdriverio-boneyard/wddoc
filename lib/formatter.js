        ...
        if(example && example[0]) {
            ...
            example.forEach(function(line) {
                ...
                if((checkForFilenameExpression && checkForFilenameExpression.length) || (currentLine === example.length)) {
                    ...
                    exampleFilename = checkForFilenameExpression[0].substr(1);
                }
